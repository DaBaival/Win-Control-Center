...
function _page($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    let mouseSpeed = 10;
    let apps = [];
    $$renderer2.push(`<main class="svelte-1uha8ag"><section class="merged-controls svelte-1uha8ag"><div class="control-row svelte-1uha8ag"><div${attr_class(
      `icon-box ${stringify(
        /**
         * @param {Function} func
         * @param {number} wait
